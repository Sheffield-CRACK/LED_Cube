...
data = gpiozero.DigitalOutputDevice(11, initial_value=False, active_high=True)
clock = gpiozero.DigitalOutputDevice(13, initial_value=False, active_high=True)
reset = gpiozero.DigitalOutputDevice(15, initial_value=True, active_high=True)
